...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    copy: {
      ...
      student:{
        files: [{
          expand: true,
          dot: true,
          cwd: '.tmp/concat/dist/student',
          dest: '<%= yeoman.dist %>/student',
          src: [
            '*.html',
            '{,*/}*.html',
            '{,*/}*.js'
    ...
    requirejs:{
      dist:{
        options:{
            baseUrl: '<%= yeoman.student %>',
            mainConfigFile: '<%= yeoman.student %>/require.config.js',
            removeCombined: true,
            findNestedDependencies: true,
            optimize: 'none',
            dir: '.tmp/concat/dist/student',
            modules: [{
                name:'main',
                include:["requirejs","require.config.dist","text", "ngload", "main"]
            }, {
                name: 'home/HomeCtrl',
                exclude: ["main"]
            }, {
                name: 'about/AboutCtrl',
                exclude: ["main"]
            }]
        }
      }
  ...
  grunt.registerTask('clearBuild','清除构建后dist目录产生的无用文件',function () {
    grunt.file.delete('dist/student/require.config.js');
  });
